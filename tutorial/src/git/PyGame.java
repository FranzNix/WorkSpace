...
// creates YourRoom with no arguments  
  ...
  int choice = 0;
  choice =  (input("Enter a Number for your Choice, Remember Both have potential Danger"));
  scan.nextInt();
...
//public static voidines door1 with no arguments 
  ...
  int choice = (input("Choose 1 to Go, Choose 2 to Stay"));
...
// public static voidines basement1 with nho arguments
  ...
  int choice = (input("Say 1 to take clothes. Say 2 to leave them"));
...
// public static voidines the variable secretpassage() 
  ...
  choice = (input("Enter 1 for door 1, 2 for door 2, 3 for door 3, or 4 to leave."));
  Scanner.nextInt();
  ...
  // else ( if ( ( the user choice is equal to 4 continue
    ...
    choice = (input("Enter 1 for Yes, or 2 to go back to secret passage."));
    Scanner.nextInt();
...
// public static void function Endgame()
  System.out.println ("Congratulations!");
  // System.out.printlns "Congratulations!"
  //sleep(2)
  // //sleeps the program for 2 seconds
